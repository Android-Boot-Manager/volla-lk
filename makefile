...
### microtrust lite version use start ---liaojie-20191202
ifeq ($(strip $(MICROTRUST_TEE_SUPPORT)),yes)
DEFINES += CFG_MICROTRUST_TEE_SUPPORT
endif
### microtrust lite version use end ---liaojie-20191202
ifeq ($(MTK_VERIFIED_BOOT_SUPPORT),yes)
DEFINES += MTK_VERIFIED_BOOT_SUPPORT
endif

#prize-add tangan-20170921 for serial_num -start
#ifeq ($(CUSTOM_LK_USB_UNIQUE_SERIAL),yes)
CFLAGS += -DCONFIG_MTK_USB_UNIQUE_SERIAL
#endif
#prize-add tangan-20170921 for serial_num -end
